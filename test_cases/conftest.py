...
def init_appium(request):
    globals()['get_data_path'] = "C:/Automation/PythonHachathon/files/mobile_data.xml"
...
def init_desktop(request):
    ...
    driver = EventFiringWebDriver(e_driver, EventListener())
    globals()['driver'] = driver
    globals()['get_data_path'] = "C:/Automation/PythonHachathon/files/calc_db_query.xml"
...
@pytest.fixture(scope="class")
def init_api():
    globals()['get_data_path'] = "C:/Automation/PythonHachathon/files/api_parameters.xml"
...
def init_electron(request):
    globals()['get_data_path'] = "C:/Automation/PythonHachathon/files/parameters_electron.xml"
